...
| `meteofrance-observation-candidate-doc.md` | API Ciblee Donnees d'Observation et observations reseau sol temps reel/quasi temps reel. | Candidate documentee, testee manuellement, non integree dans le Worker. | Aucun endpoint Worker dedie. | Quotas, selection station proche et disponibilite locale des champs non confirmes. |
